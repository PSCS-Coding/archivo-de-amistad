        ...
        <div class="row text-center text-lg-left">
            ...
            while ($fac_row = $query->fetch_row()) { ?>
                <div class="card" style="width: 20rem;">
                    <img class="card-img-top" src="<?php echo $fac_row[1] ?>" alt="Image failed to load.">
                      <div class="card-body">
    <p class="card-text">Name coming soon.</p>
  </div>
            </div>
            <?php } ?>
        </div>
            ...
            <div class="modal-content">
                ...
                <form action="upload.php" method="post" enctype="multipart/form-data">
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label for="message-text" class="col-form-label">Meme Name:</label>
                            <input type="text" name="memeName" id="memeName">
                        </div>
                    </div>
